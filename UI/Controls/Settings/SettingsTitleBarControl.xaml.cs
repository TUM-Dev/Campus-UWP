...
{
    public sealed partial class SettingsTitleBarControl: UserControl
    {
        //--------------------------------------------------------Attributes:-----------------------------------------------------------------\\
        #region --Attributes--
        public Frame Frame
        ...
        public static readonly DependencyProperty FrameProperty = DependencyProperty.Register(nameof(Frame), typeof(Frame), typeof(SettingsTitleBarControl), new PropertyMetadata(null, OnFrameChanged));
        ...
        public static readonly DependencyProperty GlyphProperty = DependencyProperty.Register(nameof(Glyph), typeof(string), typeof(SettingsTitleBarControl), new PropertyMetadata("\uE9CE"));
        ...
        public static readonly DependencyProperty TextProperty = DependencyProperty.Register(nameof(Text), typeof(string), typeof(SettingsTitleBarControl), new PropertyMetadata("Text"));
        ...
        public static readonly DependencyProperty BackRequestButtonVisibilityProperty = DependencyProperty.Register(nameof(BackRequestButtonVisibility), typeof(Visibility), typeof(SettingsTitleBarControl), new PropertyMetadata(Visibility.Visible));
        ...
        public static readonly DependencyProperty NavigationFallbackPageProperty = DependencyProperty.Register(nameof(NavigationFallbackPage), typeof(Type), typeof(SettingsTitleBarControl), new PropertyMetadata(typeof(MainPage)));
        ...
        public static readonly DependencyProperty IsActiveProperty = DependencyProperty.Register(nameof(IsActive), typeof(bool), typeof(SettingsTitleBarControl), new PropertyMetadata(false, OnIsActiveChanged));

        #endregion
        //--------------------------------------------------------Constructor:----------------------------------------------------------------\\
        #region --Constructors--
        public SettingsTitleBarControl()
        {
            InitializeComponent();
            SetupTitleBar();
        ...
        {
            if (d is SettingsTitleBarControl titleBarControl)
            {
