...
{
    public sealed class LogLevelControlTemplate: AbstractDataTemplate
    {
        //--------------------------------------------------------Attributes:-----------------------------------------------------------------\\
        #region --Attributes--
        ...
        //--------------------------------------------------------Constructor:----------------------------------------------------------------\\
        #region --Constructors--
        public LogLevelControlTemplate()
        {
            LoadSettings();
        }
        ...
        private void SetLogLevel(LogLevelDataTemplate value)
        {
            ...
            {
                Storage.Classes.Settings.SetSetting(SettingsConsts.LOG_LEVEL, (int)value.LogLevel);
